        ...
        <div>
            <div className="post">
                ...
                <div className="like-bar">
                    <button className="like-bar__btn">Like</button> <span className="like-bar__number">54 People Like it!</span>
                </div>
                <div className="comment-section">
                    <div className="comment">
                        ...
                        <div className="comment__structure">
                            ...
                            <div className="like-bar">
                                <button className="like-bar__btn">Like</button> <span className="like-bar__number">23 People Like it!</span>
                            </div>
                        </div>
                    </div>
                </div>
